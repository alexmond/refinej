...
/**
 * Base exception for all RefineJ refactoring errors. Subclass for specific failure modes
 * so the CLI can present tailored messages.
 */
public class RefactorException extends RuntimeException {
	...
	public static class SymbolNotFoundException extends RefactorException {
		...
		public SymbolNotFoundException(String qualifiedName) {
			super("Symbol not found in index: " + qualifiedName + ". Run 'refinej index' first.");
		}
