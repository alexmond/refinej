...
/**
 * The result of a {@code computeRename} or {@code computeMove} operation. Always computed
 * first (pure, no file writes). Pass to {@code apply()} to write changes to disk.
 *
 ...
 */
public record ChangeSet(List<FileChange> changes, List<Conflict> conflicts, boolean dryRun) {
