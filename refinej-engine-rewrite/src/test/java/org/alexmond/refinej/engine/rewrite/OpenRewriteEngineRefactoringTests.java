...
/**
 * Integration tests for {@link OpenRewriteEngine} refactoring operations (rename and
 * move).
 *
 * <p>
 ...
 */
@DisplayName("OpenRewriteEngine refactoring")
class OpenRewriteEngineRefactoringTests {
